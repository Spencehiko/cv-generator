...
import Education from "@/components/preview/sidebar/sections/Education.vue";
            ...
            <div class="flex flex-col gap-1 w-full print:gap-0">
                <div class="flex flex-row flex-nowrap justify-between">
                    ...
                    <div class="flex flex-row gap-1 items-center">
                        ...
                        <span>-</span>
                        <span v-if="data['endDate']" class="text-gray-500 text-lg">
                            {{ (data["endDate"].month + 1 < 10 ? "0" + (data["endDate"].month + 1) : data["endDate"].month + 1) + "/" + data["endDate"].year }}
                        </span>
                        <span v-else class="text-gray-500 text-lg"> NOW </span>
                    </div>
                </div>
